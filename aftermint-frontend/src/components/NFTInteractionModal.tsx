    ...
    >
      <div className="bg-gradient-to-br from-gray-900/95 via-gray-800/90 to-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-700/40 w-full max-w-md max-h-[90vh] overflow-hidden shadow-2xl shadow-cyan-500/10">
        ...
        <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 backdrop-blur-sm border-b border-gray-600/30 p-6 flex justify-between items-start">
          <div className="flex-1 min-w-0">
            ...
            {nft.owner && (
              <div className="flex items-center gap-2 text-sm">
                <User size={14} className="text-theme-text-secondary flex-shrink-0" />
                <span className="text-theme-text-secondary">Owner:</span>
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-theme-hover rounded-xl transition-all duration-300 text-theme-text-secondary hover:text-white flex-shrink-0 ml-2"
          >
            <X size={20} />
          </button>
        </div>
          ...
          {nft.isListed && nft.price && (
            <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-xl p-4 border border-gray-600/30">
              <div className="flex items-center justify-between">
                <span className="text-theme-text-secondary font-medium">Current Price</span>
          ...
          <div className="space-y-3 pt-2">
                ...
                <div>
                  ...
                  <div className="mt-3">
                    <label className="flex items-center">
                      ...
                      />
                      <span className="text-sm text-theme-text-primary">Custom expiration date</span>
                    </label>
            ...
            {isOwner && (
              <div className="text-center py-4">
                <p className="text-theme-text-secondary text-lg">You own this NFT</p>
              </div>
            )}
