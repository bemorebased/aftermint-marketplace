            ...
            <div className="w-full mt-2 flex flex-col items-center">
              ...
              <div className="grid grid-cols-2 gap-2 w-full mb-3">
                <div className="bg-theme-primary/40 border border-theme-primary/60 rounded-lg p-2 text-center">
                  ...
                  <p className="font-bold text-theme-text-primary">{floorPrice !== undefined ? `${floorPrice} BASED` : 'N/A'}</p>
                </div>
                
                <div className="bg-theme-primary/40 border border-theme-primary/60 rounded-lg p-2 text-center">
                  <p className="text-sm text-theme-text-primary font-medium mb-1">Items</p>
                  <p className="font-bold text-theme-text-primary">{items !== undefined ? items : 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="flex gap-2 mt-2">
                {website && (
                  <button 
                    ...
                    className="p-2 rounded-full bg-theme-primary/30 text-theme-text-primary hover:bg-theme-primary hover:text-black transition-colors cursor-pointer"
