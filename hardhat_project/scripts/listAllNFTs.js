...
async function main() {
  ...
  // List of NFTs with different prices
  const nftsToList = [
    { tokenId: 0, price: hre.ethers.parseEther("0.5") },  // 0.5 ETH/BASED
    { tokenId: 1, price: hre.ethers.parseEther("1.0") },  // 1.0 ETH/BASED
    { tokenId: 2, price: hre.ethers.parseEther("1.5") },  // 1.5 ETH/BASED
    { tokenId: 3, price: hre.ethers.parseEther("0.75") }, // 0.75 ETH/BASED
    { tokenId: 4, price: hre.ethers.parseEther("2.0") }   // 2.0 ETH/BASED
  ];
  ...
  for (const nft of nftsToList) {
    ...
    try {
      ...
      // List the NFT with the marketplace
